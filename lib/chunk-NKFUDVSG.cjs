...
var _chunkS5PYBY4Ucjs = require('./chunk-S5PYBY4U.cjs');





var _chunkNLFS5KAZcjs = require('./chunk-NLFS5KAZ.cjs');
...
var Ihbp = class extends _events2.default {
  constructor(options, puppeteerOptions = {}) {
    ...
    this.puppeteerOptions = { ..._chunkNLFS5KAZcjs.DEFAULT_PUPPETEER_OPTIONS, ...puppeteerOptions };
    this.options = { ..._chunkNLFS5KAZcjs.DEFAULT_CLIENT_OPTIONS, ...options };
    this.pwned = new (0, _chunkS5PYBY4Ucjs.Pwned)();
  ...
  async navigateToHIBP() {
    await _optionalChain([this, 'access', _ => _.page, 'optionalAccess', _2 => _2.goto, 'call', _3 => _3(_chunkNLFS5KAZcjs.HIBP_URL, {
      waitUntil: "networkidle0",
      timeout: 0,
      referer: _chunkNLFS5KAZcjs.HIBP_REFERRER
    })]);
  }
