...
var Password = class {
  ...
  async isPasswordPwned(page, password) {
    try {
      ...
      await page.type(_chunkM2H67WW7cjs.PASSWORD_INPUT, password, { delay: 120 });
  ...
  async isConfirmationMessageInDom(page) {
    try {
      return await _chunkT6OIEQM6cjs.isElementInDom.call(void 0, page, _chunkM2H67WW7cjs.PWNED_MESSAGE_CONTAINER);
    } catch (error) {
      return false;
    }
  }
