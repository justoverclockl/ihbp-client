...
var _chunk3DS5J6CZcjs = require('./chunk-3DS5J6CZ.cjs');
...
var Ihbp = class extends _events2.default {
  constructor(options, puppeteerOptions = {}) {
    ...
    this.puppeteerOptions = { ..._chunkRUGBXIRXcjs.DEFAULT_PUPPETEER_OPTIONS, ...puppeteerOptions };
    this.options = { ..._chunkRUGBXIRXcjs.DEFAULT_CLIENT_OPTIONS, ...options };
    this.password = new (0, _chunk3DS5J6CZcjs.Password)();
  }
  when(event, listener) {
